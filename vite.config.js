...
const isWpMode = process.env.NODE_ENV === "wp" || process.argv.includes("--mode=wp");
    ...
    build: {
      ...
      rollupOptions: {
        ...
        output: {
          ...
          // コード分割の最適化
          manualChunks: isWpMode ? undefined : {
    ...
    plugins: [
      ...
      handlebars({
        ...
        context: (pagePath) => ({
          ...
          environment: isWpProdMode ? 'production' : isWpDevMode ? 'development' : 'static'
        }),
      }),
    ],
    resolve: {
